...
preview_id:5)Comment.create(body:"As one of only a handful enjoying a remarkable Rumanian reproduction of The Master and Margarita in our local art-house theatre I couldn't help but wonder what today's culturally degenerated youth were doing instead? We must give back the USA to the native Americans right away! But I guess that's just what happens when we let Saudi oil magnates rape our ecosystems and ruin the planet.", author_id:2,
preview_id:4)Comment.create(body:"Get Boris out., The Chilterns.", author_id:2,
preview_id:6)Comment.create(body:"More in it than most", author_id:2,
preview_id:9)Comment.create(body:"More in it than most, ", author_id:1,
preview_id:8)Comment.create(body:"More in it than most, ", author_id:1,
preview_id:7)Comment.create(body:"More in it than most, ", author_id:1,
preview_id:8)Comment.create(body:"As one of only a handful enjoying a remarkable Rumanian reproduction of The Master and Margarita in our local art-house theatre I couldn't help but wonder what today's culturally degenerated youth were doing instead? Why are the cis-sexual backlash movement intent on opressing my right to fair-trade cocoa? That's what we learned from Toussaint L'Ouverture.", author_id:1,
preview_id:4)
preview_id:9)Comment.create(body:"As one of only a handful enjoying a remarkable Rumanian re", author_id:2,
preview_id:1)Comment.create(body:"As one of only a handful enjoying a remarkable Rumanian re", author_id:2,
preview_id:1)Comment.create(body:"As one of only a handful enjoying a remarkable Rumanian re", author_id:1,
preview_id:1)Comment.create(body:"As one of only a handful enjoying a remarkable Rumanian re", author_id:1,
preview_id:3)Comment.create(body:"As one of only a handful enjoying a remarkable Rumanian re", author_id:1,
preview_id:3)Comment.create(body:"A touch of nutmeg really bolsters the egg flavours ", author_id:2,
preview_id:5)Comment.create(body:"A touch of nutmeg really bolsters the egg flavours ", author_id:2,
preview_id:5)Comment.create(body:"A touch of nutmeg really bolsters the egg flavours ", author_id:2,
preview_id:3)
